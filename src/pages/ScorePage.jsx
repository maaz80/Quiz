    ...
    <div className="container mx-auto p-4 bg-gray-100 min-h-screen">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="flex justify-between mb-6">
          <div className="text-center p-1 md:p-4 bg-blue-50 rounded-lg">
            <p className="text-xs md:text-sm text-gray-600">Time Taken</p>
            <p className="text-sm md:text-2xl font-bold text-blue-600">{completionTime}s</p>
          </div>
          <div className="text-center p-1 md:p-4 bg-green-50 rounded-lg">
            <p className="text-xs md:text-sm text-gray-600">Final Score</p>
            <p className="text-sm md:text-2xl font-bold text-green-600">{score}/10</p>
          </div>
          <div className="text-center p-1 md:p-4 bg-yellow-50 rounded-lg">
            <p className="text-xs md:text-sm text-gray-600">Total Attempts</p>
            {/* Adding attepts  */}
            <p className="text-sm md:text-2xl font-bold text-yellow-600">{Object.values(attemptsData).reduce((a, b) => a + b, 0)}</p>
          </div>
          <div className="text-center p-1 md:p-4 bg-purple-50 rounded-lg">
            <p className="text-xs md:text-sm text-gray-600">Overall Rating</p>
